<template>
  <div id="center_fz8">
    ...
    <div
      style="z-index: 100; float: right;width: 200px; padding:5px;margin: 5px; height:95vh;background:rgba(50, 50 ,50, 0.8);position: absolute;border-radius: 4px">
      <form>
...
// name: 'Test',
  ...
  data() {
    return {
      ...
      div_info_taizhan: {
        title: '会战地图',
        cnt: '在地图中展示了整个黑土区，地图中可以看到7个辐射区。分别为大河湾、海伦、三江、大安、长春、沈阳辐射区。',
        img: ''
      },
