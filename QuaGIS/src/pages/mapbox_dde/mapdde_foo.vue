<template>
  ...
  <menu v-show="!close_e" style="padding:.1rem;z-index: 100; float: right;position: absolute;"
        class="away_top">
    <li style="position:inherit;" class="qqq" @click="close_e=!close_e">

      <!--<icon name="expand-alt" style="width: 0.5rem;height: 0.5rem"></icon>-->

      <q-icon name="cog" style="width: 0.5rem;height: 0.5rem" class="fa-pulse"></q-icon>
    </li>
  </menu>

  <div class="away_top grey_box" v-show="close_e"
       style="">


    <menu style="padding-left: 3.5rem;z-index: 120">

      <li style="position:inherit;" class="qqq" @click="close_e=!close_e">

        <q-icon name="compress-alt" style="width: 0.35rem;height: 0.35rem"></q-icon>

      </li>
    </menu>


    <hr style="position: absolute;top: 11.5rem; width: 97%"/>
    <form style="position: absolute;top: 11.4rem;">


      <p><b>Position:</b> {{ info_mouse_pos }}</p>
      <p><b>Center:</b> {{ info_map_center }}</p>
      <p><b>Zoom:</b> {{ info_map_zoom }}</p>
