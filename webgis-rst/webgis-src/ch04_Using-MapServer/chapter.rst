...
.. toctree::
   ...
   sec01_raster/section
   sec02_grid/section
   sec03_format/section
   sec04_one-layer/section
   sec05_two-layers/section
   sec06_multiple-layers/section
   sec07_classes/section
   sec08_labels/section
   sec09_symbol/section
