...
So we assume that the earth is round. To make it flat, we put an imaginary cylinder around it, 
...
This example again uses the timeout to automatically alternate between zoom levels 0 and 1:
