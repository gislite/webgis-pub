...
.. image:: http://webgis.pub/cgi-bin/mapserv?map=/owg/mfa1.map&layer=world-country&mode=map


Instead of browsing it on the HTML page, you can just enter this URL:

http://webgis.pub/cgi-bin/mapserv?map=/owg/mfa1.map&layer=world-country&mode=map
