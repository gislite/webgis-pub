...
.. image:: https://webgis.pub/cgi-bin/mapserv?map=/owg/mfa1.map&layer=world-country&mode=map


Instead of browsing it on the HTML page, you can just enter this URL:

https://webgis.pub/cgi-bin/mapserv?map=/owg/mfa1.map&layer=world-country&mode=map
...
The first part, ``https://webgis.pub/cgi-bin/mapserv?``, calls MapServer’s CGI
...
https://webgis.pub/cgi-bin/mapserv?map=/owg/mfa1.map&layer=states&mode=browse&template=OpenLayers
