...
.. image:: https://webgis.pub/cgi-bin/mapserv?map=/owg/mfk3.map&layer=country&layer=weq&mode=map

or:

.. image:: https://webgis.pub/cgi-bin/mapserv?map=/owg/mfa3.map&layer=states_poly&layer=states_line&mode=map
